...
import com.metricstream.systemi.dao.TrakrInputDao;
...
public class NlpIndexer {
	
	private static final Logger logger = LoggerFactory.getLogger(NlpIndexer.class);
	...
	public String detectSubCategoryAndUpdate() throws SQLException, IOException {
		NlpCategoriesDao nlpDao = new NlpCategoriesDao();
		TrakrInputDao trakrinputDao = new TrakrInputDao();
